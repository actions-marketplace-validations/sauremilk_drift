...
3. **Drift modeling level:** drift currently models 15 signal families (all scoring-active since v0.7.0), covering a subset of cross-file erosion patterns with strong reproducibility.
