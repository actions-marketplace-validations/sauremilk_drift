...
- scoring model: 14 scoring signals in the current composite model; 9 additional signals are report-only, with TVS currently held report-only pending re-validation
